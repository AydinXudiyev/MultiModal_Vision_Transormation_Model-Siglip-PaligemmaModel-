...
class SiglipVisionEmbeddings(nn.Module):
    ...
    def forward(self,pixel_values:torch.FloatTensor) -> torch.Tensor:
        ...
        # The output of the convolution will have shape [Batch_Size,Embed_Dim,Num_Patches_H,Num_Pacthes_W]
        # Where Num_Patches_H = height // patch_size and  Num_Patch_W = width // patch_size
        patch_embeds=self.patch_embedding(pixel_values)
        # [Batch_Size,Embed_Dim,Num_Patches_H,Num_Patch_W] -> [Batch_Size,Embed_Dim,Num_Patches]
...
class  SiglipAttention(nn.Module):
    """Multi-headed attetion from 'Attention Is All You Need' paper"""
    ...
    def forward(
        ...
        # Apply the softmax row-wise. attn_weights: [Batch_size,Num_Head,Num_Patches,Num_Patches]
...
class SiglipVisionTransformer(nn.Module):
    ...
    def forward(self,pixel_values:torch.Tensor)-> torch.Tensor:
        #pixe_values: [Batch_Size,Channels,Height,Width] -> [Batch_Size,Num_Patches,Embed_dim]
